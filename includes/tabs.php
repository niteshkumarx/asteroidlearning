...
<a href=\"asteroid/learner.php\" style=\"color:000000; font-size:1.1em; \">"."Hi, <b class=\"linky\">".$_SESSION['learner_name']."</b></a> </div>";
}?>
...
<menu id="cbp-tm-menu" class="cbp-tm-menu" style=" bottom: 2px; ">
   <li > <a href="" title="Learn or Educate, whatever suits you better" >Your Roles</a><span Style="opacity:0.95;">
    	<ul class="cbp-tm-submenu" style="font-size:.65em;">
						<li><a href="asteroid/login.php" >Learner</a></li>
   ...
   <!--electronics ends-->
<div class="home"><a href="asteroidlearning.php" title="Home">Home</a></div>

<div class="exploreimg"><img src="images/explore.png" height="80px" ></div>
<div class="explore"> <a href="asteroid/bytes.php" title="Explore the future of silicon industry"><span class="ExploreCharacterStyle">/BYTES//</span></a> </div>