...
INSERT INTO `cities` (`city_id`, `city`, `city_state`) VALUES
...
(1550, 'Dwarka1', 'Delhi'),
(1551, 'Etah', 'unknown'),
(1552, 'Faizabad', 'Uttar Pradesh'),
(1553, 'Falna', 'unknown'),
(1554, 'Farrukhabad', 'Uttar Pradesh'),
(1555, 'Fatehgarh', 'unknown'),
(1556, 'Fatehpur Chaurasi', 'unknown'),
(1557, 'Fatehpur Sikri', 'Uttar Pradesh'),
(1558, 'Firozabad', 'Uttar Pradesh'),
(1559, 'Gadchiroli', 'unknown'),
(1560, 'Gandhidham', 'Gujarat'),
(1561, 'Ganjam', 'unknown'),
(1562, 'Ghatampur', 'unknown'),
(1563, 'Ghatanji', 'unknown'),
(1564, 'Ghaziabad', 'Uttar Pradesh'),
(1565, 'Ghazipur', 'Uttar Pradesh'),
(1566, 'Goa Velha', 'unknown'),
(1567, 'Gokak', 'unknown'),
(1568, 'Gondiya', 'unknown'),
(1569, 'Gorakhpur', 'Uttar Pradesh'),
(1571, 'Guna', 'Madhya Pradesh'),
(1572, 'Hanumangarh', 'unknown'),
(1573, 'Harda', 'unknown'),
(1574, 'Harsawa', 'unknown'),
(1575, 'Hastinapur', 'unknown'),
(1576, 'Hathras', 'Uttar Pradesh'),
(1579, 'Jagadhri', 'unknown'),
(1580, 'Jais', 'unknown'),
(1581, 'Jaitaran', 'unknown'),
(1582, 'Jalgaon', 'Maharashtra'),
(1583, 'Jalore', 'unknown'),
(1584, 'Jhabua', 'unknown'),
(1585, 'Jhalawar', 'Rajasthan'),
...
--
-- Table structure for table `gtx_buycart`
--

CREATE TABLE IF NOT EXISTS `gtx_buycart` (
  `gtx_serial` int(30) NOT NULL AUTO_INCREMENT,
  `gtx_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `gtx_name` varchar(30) NOT NULL,
  `gtx_email` varchar(40) NOT NULL,
  ...
  `promos` varchar(10) NOT NULL,
  `gtx_asteroid` varchar(30) NOT NULL,
  `comment` varchar(50) NOT NULL,
  PRIMARY KEY (`gtx_serial`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `gtx_registration`
--

CREATE TABLE IF NOT EXISTS `gtx_registration` (
  `gtx_serial` int(30) NOT NULL AUTO_INCREMENT,
  `gtx_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `gtx_dateob` date NOT NULL,
  `gtx_name` varchar(30) NOT NULL,
  `gtx_email` varchar(40) NOT NULL,
  `gtx_auth` varchar(50) NOT NULL,
  `contact` bigint(11) NOT NULL,
  `city` varchar(35) NOT NULL,
  `course` varchar(20) NOT NULL,
  `domain_main` varchar(20) NOT NULL,
  `multiple` varchar(50) DEFAULT NULL,
  `participants` varchar(10) NOT NULL,
  `gender` varchar(10) NOT NULL,
  `gtx_dp` varchar(100) NOT NULL,
  `promos` varchar(5) NOT NULL,
  `gtx_asteroid` varchar(30) NOT NULL,
  `comment` varchar(50) NOT NULL,
  PRIMARY KEY (`gtx_serial`)
...
--
-- Dumping data for table `gtx_registration`
--

INSERT INTO `gtx_registration` (`gtx_serial`, `gtx_time`, `gtx_dateob`, `gtx_name`, `gtx_email`, `gtx_auth`, `contact`, `city`, `course`, `domain_main`, `multiple`, `participants`, `gender`, `gtx_dp`, `promos`, `gtx_asteroid`, `comment`) VALUES
(32, '2015-09-23 13:13:27', '1991-03-14', 'Nitesh Kumar', 'niteshkumaronline@yahoo.co.in', '6f9bdd7073920ff61c0293fd0371c97e', 8127218512, 'Allahabad', 'GRAPHHIC', 'COMPUTERSC', '', '20', 'Male', 'upload_images/31fcb6b9808f24de19edcd40fa70b642.jpg', 'YES', '', ''),
(44, '2015-09-20 03:47:44', '2000-11-04', 'Manu', 'manu@casitastudios.com', 'de63cd9897f3eef7fb3253f39d0fe8b7', 1234567891, 'Allahabad | Uttar Pradesh', 'BIGDATA', 'COMPUTERSC', '', '1', 'Male', 'upload_images/27ae317bc50494a3a7e0b6b3f147f089.jpg', 'NO', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `gtx_workshop`
--

CREATE TABLE IF NOT EXISTS `gtx_workshop` (
  `gtx_serial` int(30) NOT NULL AUTO_INCREMENT,
  `gtx_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `gtx_name` varchar(30) NOT NULL,
  `gtx_email` varchar(40) NOT NULL,
...
--
-- Dumping data for table `gtx_workshop`
--

INSERT INTO `gtx_workshop` (`gtx_serial`, `gtx_time`, `gtx_name`, `gtx_email`, `contact`, `city`, `institute`, `course`, `participants`, `promos`, `gtx_asteroid`, `comment`) VALUES
(1, '2015-09-14 04:48:55', 'Manu', 'manu@casitastudios.com', 8775674485, 'Allahabad', 'Tagore', 'WEB', '30', 'YES', '', '');
